...
import Data from './detailDocuments.json'
import { useState } from 'react'
const inter = Inter({ subsets: ['latin'] })
let otherpage_link = "pages/other.tsx"
export default function Home() {
  
  let data = JSON.stringify(Data)
  let data1 = useState(JSON.stringify(Data))
  console.log("I will log data object "+ data)
  return (
    <>
      <Head>
